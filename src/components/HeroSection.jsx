      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 h-screen flex flex-col lg:flex-row items-center justify-between pt-4 pb-12">
        ...
        <motion.div className="w-full lg:w-1/2 lg:pr-8 mb-10 lg:mb-0 z-10" style={{ y: contentY, opacity }}>
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#ffffff] leading-tight tracking-tight">
              Connect,{" "}
            ...
            <div className="mt-10 flex flex-wrap gap-4 items-center">
              <motion.button
                ...
                className="group relative bg-gradient-to-r from-cyan-600 to-teal-600 text-[#ffffff] px-8 py-4 rounded-md font-medium shadow-lg shadow-cyan-700/20 hover:from-cyan-500 hover:to-teal-500 transition-all"
              ...
              <Link to="/learn-more">
                <motion.button
                  className="text-[#ffffff] border border-teal-700/30 hover:border-teal-600/60 px-8 py-4 rounded-md font-medium transition-all"
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                ...
                >
                  ...
                  <div>
                    <span className="block font-bold text-2xl text-[#ffffff]">{stat.value}</span>
